...
(function (exports) {
    ...
    exports.web2app = (function () {
         ...
         * @example mwapptools.web2app({ urlScheme : 'daumapps://open', intentURI : '', storeURL: 'itms-app://...', appName: '다음앱' });
         */
        return web2app;
        
    })();
    
})(window.mwapptools = (typeof window.mwapptools === 'undefined') ? {} : window.mwapptools);
...
(function (exports) {
    ...
    exports.mwapptools = (typeof exports.mwapptools === "undefined") ? {} : exports.mwapptools;
    if(exports.mwapptools.web2app !== "undefined") {
        exports.mwapptools.web2app.version = "0.1.18";
    }
}(window));