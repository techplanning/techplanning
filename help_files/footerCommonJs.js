		...
		for(var idx = 0 ; idx < grpData.length ; idx++) {
			...
			if(data.CtgrLv == 1) {
				...
				if(data.CtgrNo == 476017){//DLUXURY11 처리
					...
					layerHtml += '<li><a href="http://globalshopping.11st.co.kr/global/GlobalCategoryAction.tmall?method=globalMCtgr&dispCtgrNo=' + data.CtgrNo + '" onClick="headSel(\'1\', \'' + data.CtgrNm + '\');'+gaLink+'">' + data.CtgrNm + '</a></li>';
				}
			}
		}
